...
const Festivals = () => {
  ...
  return (
    <section className='w-5/6 md:w-11/12 mt-5 mx-auto'>
      <h2 className='w-fit border-b border-green text-2xl text-center mx-auto'>Traditional Festivals & Carnival</h2>
      <div className='h-[400px]'>
        <Slider {...settings}>
          {festivalData.map((obj) => {
            return (
              <div className="card" key={obj.title}>
                ...
                <img src={obj.image || ""} className="w-full h-48 rounded-lg mx-auto" alt="image" />
